...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseDatabase mFirabaseDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Firabase Database");
    ...
    private void initFirebase() {
        ...
        mFirabaseDatabase=FirebaseDatabase.getInstance();
        mDatabaseReference=mFirabaseDatabase.getReference();
    }
